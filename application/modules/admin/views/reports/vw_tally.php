                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">		
											...
											<select class="show-tick selectpicker form-control" name="cat-name" id="filter-tally" data-live-search="true">
												...
												<?php foreach($categories as $c):?>
													<?php if(strcasecmp($cat_name, $c->cat_id) == 0) :?>
														<option value="<?=html_escape($c->cat_name)?>"><?=html_escape($c->cat_name)?></option>
													<?php else:?>
														<option value="<?=html_escape($c->cat_name)?>" ><?=html_escape($c->cat_name)?></option>
													<?php endif;?>
												<?php endforeach;?>
								...
								<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
									<br>
									<button type="submit" id = "btn-reset" class="btn btn-lg btn-block bg-green waves-effect">Reset Physical Inventory</button>
								</div>
								<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
									<br>
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
									 <div class="table-responsive js-sweetalert">
										<table class="table table-condensed table-hover" id="dt-tally">
											<thead>
												<tr class="col-green">
