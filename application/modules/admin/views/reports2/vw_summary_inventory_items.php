            ...
            <div class="row clearfix">	
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">		
								<form action ="<?php echo base_url('admin/reports/summary_inventory');?>" method="POST" class='rpt'>
								...
								<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
									<br>
									<button id="btn-print-sinvent" data-href='<?php echo base_url("admin/reports/pdf_summary_inventory/$date_from/$date_to");?>' data-href2='<?php echo base_url("admin/reports/pdf_summary_inventory/$date_from/$date_to");?>' data-loc='<?php echo base_url("admin/reports/pdf_summary_inventory/");?>' class="btn btn-block bg-green waves-effect open-print-window btn-rpt-print">
								...
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								 ...
								 <div class="table-responsive js-sweetalert">
									<table class="table table-condensed table-hover dt-rpt" id="dt-sinvent">
										<thead>
											<tr class="col-green">
												<th>Category</th>
										...
										<?php 
											$grand_total_cost = 0;
											foreach($summary_inventory as $i):
												$grand_total_cost = $grand_total_cost + $i->total_cost;
											?>									
											<tr>
