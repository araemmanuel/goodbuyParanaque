...
class Inventory extends My_Controller {
	...
	{
		$this->form_validation->set_rules('modal-supplier', 'Supplier Name', 'trim|required|callback_edit_supplier_check');
	...
	{	
		...
		$data['is_addressed'] = 1;
		$this->mdl_notification->_update("notif_id", $notif_id, $data);
		$this->log_data("Notification Addressed", "Notification addressed for Prod: "+$prod_id+" SKU: "+$sku);										
	}
	// 2019/10/13 Sigrid add end -------------------------<
