<!-- Bootstrap Select Css -->
    ...
    <link href="<?php echo base_url('assets/customer/css/sign_up.css');?>" rel="stylesheet">
    ...
    <link href="<?php echo base_url('assets/customer/plugins/bootstrap-mega-menu/css/style.css');?>" rel="stylesheet">
     ...
     <!-- noUISlider Css -->
    <link href="<?php echo base_url('assets/customer/plugins/nouislider/nouislider.min.css');?>" rel="stylesheet" />
    ...
    <link href="<?php echo base_url('assets/customer/plugins/material-design-iconic-font/css/material-design-iconic-font.css');?>" rel="stylesheet">
	...
	<link href="<?php echo base_url('assets/customer/css/order_management.css');?>" rel="stylesheet">
	<!-- Custom Css -->
