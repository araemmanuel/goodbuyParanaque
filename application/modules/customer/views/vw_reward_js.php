<script src="<?php echo base_url('assets/customer/js/logged_in.js');?>"></script>
	...
	<!-- Custom Js -->
    <script src="<?php echo base_url('assets/customer/plugins/jquery-datatable/jquery.dataTables.js');?>"></script>
	...
	"use strict";
		$(document).ready(function(){
			...
			check_logged_in("manage_reward");
			$('.common_element_view_banner').empty();
			$('.common_element_view_banner').append('<h2>Your Reward Card Points</h2>');
