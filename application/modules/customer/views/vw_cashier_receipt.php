		...
		<div class='receipt-body'>
			...
			<table border="0"  style="border-collapse:separate; border-spacing:2px;font-family: arial; font-size: 10.5px; text-align:center;">
				...
				<tbody>	
					...
					?>
					<tr>
						<td width="10%"><?=html_escape($o->prod_name)?></td>
						<td width="30%"><?=html_escape($o->quantity)?></td>
						<td><?=number_format(($o->quantity * $o->selling_price), 2)?></td>
					</tr>
					<?php endforeach;?>
					<tr></tr>
					<tr></tr>
				...
				<tr>
					...
					<td>
						<strong style="font-size: 10.5px;"><?php echo number_format($total_price, 2);?></strong>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<strong style="font-size: 10.5px;"> <?php echo $cash;?></strong>
					</td>		
					<tr>
						<td colspan="2" style=" text-align:right;">
						...
						<td>
							<strong style="font-size: 10.5px;"><?php echo ($cash - $total_price);?></strong>
						</td>
					</tr>
					<tr>
						<td colspan="2" style=" text-align:right;">
			...
			<br>
			<br>
			<center>Return and Exchange of items are allowed within <strong> <?php echo $return_policy;?> days </strong> <br> after the date of purchase indicated in this receipt. <br>
			<?php echo date('M d, Y h:i A'); ?><br> 
			Cashier : <?php echo ucfirst($firstname) . ' '. ucfirst($lastname); ?><br>
			Receipt No. : <?php echo $invoice_no; ?><br>
			Thank you for shopping at Goodbuy Boutique!
			</center>
		</div>
	</div>	
</div>
