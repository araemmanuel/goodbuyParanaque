...
$(document).ready(function () {
    load_cart_items();
    var categ_page = window.location.href.substring(window.location.href.indexOf("shop_sub_categ") + 15).split('/');
    var categ = categ_page[0];
    var sub_categ = categ_page[1];
    load_products_sub_categ(categ, sub_categ, base_url);
