	...
	<script src="<?php echo base_url('assets/customer/js/shop_query.js');?>"></script> <!-- Resource jQuery -->
	<script src="<?php echo base_url('assets/customer/js/view_product.js');?>"></script>
	<script type="text/javascript">
	"use strict";
		var opt_color_id,opt_size_id;
