<!-- Product View Css -->
    <link href="<?php echo base_url('assets/customer/css/checkout_view.css');?>" rel="stylesheet">
	...
	<!-- ZoomMaster Js-->
	<link href="<?php echo base_url('assets/customer/js/ZoomMasterJS/zoomove.min.css');?>" rel="stylesheet">
	
	<!-- Bootstrap Spinner Css -->
    <link href="<?php echo base_url('assets/customer/plugins/jquery-spinner/css/bootstrap-spinner.css');?>" rel="stylesheet">