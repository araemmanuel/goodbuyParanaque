...
<body class="theme-green" onload="updateClock();">
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
				<div class="row clearfix">
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
						<div class="image">
							<img src="<?php echo base_url('assets/images/gb-logo.png');?>" width="48" height="48" alt="User" />
						</div>
					</div>
            ...
            <div class="menu">
				<ul class="list">
					...
					<li id="li-start-day">
                        <?php if(!$prev_batch_ended || (isset($pos_has_started) && $pos_has_started)): ?>
							
							<a id="btn-end-day" data-title='You are about to close the batch, print the Z report, and end the day. Do you want to continue?' data-msg="This action cannot be undone." data-url="<?php echo base_url('cashier/end_day');?>" class=" cashier-confirm">
								<i class="material-icons">warning</i>
								<span>End day</span>
							</a>
						<?php else : ?>
							<a href="javascript:void(0);" id="btn-open-sday" >
					...
					<?php if(isset($pos_has_started) && $pos_has_started): ?>	
						<?php if($shift_has_started && !$shift_has_ended): ?>						
							<li>
								<a href="<?php echo base_url('cashier/end_shift');?>" >
						...
						<?php else : ?>	
							<li>
								<a href="<?php echo base_url('cashier/start_shift');?>" >
									<i class="material-icons">print</i>
					...
					<li>
                        <a href="<?php echo base_url('cashier/reports');?>" >
                            <i class="material-icons">print</i>
                            <span>Reports</span>
                        </a>
                    </li>
					...
					<li>
                        <a href="<?php echo base_url('cashier/download_mob_app');?>">
					...
					-->
					<li>
                        <a href="<?php echo base_url('cashier/logout/cashier');?>">
			...
			<!-- Footer -->
			<div class="legal" style="background:#eee;">
				<div class="copyright">
					&copy; 2018 <a href="javascript:void(0);">JACKS Development Team</a>.
				</div>
			</div>
			<!-- #Footer -->
	...
	<section id="mainClass" class="content">
        <div class="container-fluid">
           
			<div class="row clearfix">
				<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
					<!--<a class="navbar-brand" href="<?php echo base_url('admin');?>">Good<b>Buy</b> Enterprises</a>
					<button type="button" style="background:transparent;border:none;" onclick="closeNav()">
						<i class="material-icons">menu</i>
					</button>
					-->
					<button type="button" class="sidebar-menu btn bg-green btn-circle waves-effect waves-circle waves-float waves-light" onclick="closeNav()">
						<i class="material-icons">menu</i>
					</button>
					<!--<img src="<?php echo base_url('assets/images/gb-banner.png');?>" width="100%">-->
				</div>
				
				<div class="col-lg-10 col-md-10 col-sm-10 col-xs-10">
					<div class="align-right">
						<div class="btn-group" role="group">
                            <div id = "cashier-mode-menu" class="btn-group" role="group">
                                ...
                                <ul class="dropdown-menu">
									...
									<!--
									<li><a class="check-return" href="<?php echo base_url('cashier/open_reading');?>">Open Reading</a></li>
									-->
								</ul>
                            </div>
	...
	<!-- START DAY MODAL -->
	<div class="modal fade" id="modal-start-day" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
			<form action = "<?php echo base_url('cashier/start_day');?>" method = "POST" id = "form-start-day">
                <div class="modal-body">
					<br>
					<div class="form-group form-float">
						<small class="form-label col-grey">Beginning Cash Drawer</small>
						<div class="form-line success">
							<input type="number" name="beginning-cash" class="form-control">
						</div>
						<div class="validation-errors" id ="start-day_error"></div>
					</div>
                </div>
				<div class="modal-footer">
                    <button type="button" id="btn-start-day" class="btn bg-green waves-effect"><i class="material-icons">check</i> <span>START DAY</span></button>
	...
	<?php
		if((isset($pos_has_started) && $pos_has_started) && (isset($shift_has_started) && $shift_has_started)){
			echo "<script>"
					."closeNav();"
					."sessionStorage.setItem('start_day_success',true);"
				."</script>";
		}
		else
			echo "<script>sessionStorage.setItem('start_day_success',false)</script>";
	?>
	...
	<?php
		...
		if(isset($pos_has_started) && $pos_has_started){
			echo "<script>sessionStorage.setItem('start_day_success',true);</script>";
		}
		echo "<script>closeNav();</script>";
	?>