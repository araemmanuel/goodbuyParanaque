								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
												<div class="table-responsive">
													<table class="prod-info">
														<tbody>
															<tr>										
																<td width="40%" class="font-11"><b>PRODUCT NAME:</b></td>
																<td><input style="border:none;border-color:transparent;width:100%;" id = 'name' readonly /></td>
															</tr>
															<tr>
																<td width="40%" class="font-11"><b>SELLING PRICE:</b></td>
									...
									<div class="row clearfix">
										<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											...
											<div class="align-center">
												<label class="remove-b" style="font-size:13px;"><input type="radio" name="d-type"  class ="d-type" value="none" checked> None&nbsp;</label>
							...
							<div class="row clearfix">
								...
								<div class="col-lg-2 col-md-2 col-sm-4 col-xs-7">
									<div class="form-group form-group-lg">
										<div class="form-line success">
											<input type="number" name = 'cash' class="form-control" min="0.00" step="0.01" placeholder="Cash" style="height:70px;font-size:24px" />
										</div>
								...
								<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
									...
									<p class="font-18"><b>CHANGE: </b> <?php echo number_format($change, 2);?></p>
									<?php endif; ?>
								</div>
								<div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
