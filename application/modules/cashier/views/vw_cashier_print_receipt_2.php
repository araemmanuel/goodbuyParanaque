...
<div class="boxed">
	<div id = "content">
		<div class="receipt-header">
			...
			<span style="font-size:11px;">2nd Floor D&C Building, Russia St.<br>
			Parañaque City<br>
			VAT REG TIN: XXXXXXXX<br>
			TEL NO: 09328434905
			</span>
		</div>
		...
		<div class='receipt-body'>
			<table class="receipt-table">
				...
				<tbody>	
					...
					<?php if($o->selling_price != $o->amt_paid) : ?>
			...
			<center>
				...
				<table class="tax-table">
					<tbody>
						...
						<?php $vatable = number_format($total_paid/1.12,2);?>
						<tr>
